...
export let screenTextureShader = {
	...
	// Maybe uniforms will be this for babylonjs
	// uniforms: [
	// 	'uCameraIsMoving',
	// 	'uCameraJustStartedMoving',
	// 	'uEPS_intersect',
	// 	'uTime',
	// 	'uSampleCounter',
	// 	'uFrameCounter',
...
Effect.ShadersStore['pathtracing_uniforms_and_defines'] = `
...
Effect.ShadersStore['pathtracing_skymodel_defines'] = `
...
Effect.ShadersStore['pathtracing_plane_intersect'] = `
...
Effect.ShadersStore['pathtracing_disk_intersect'] = `
...
Effect.ShadersStore['pathtracing_rectangle_intersect'] = `
...
Effect.ShadersStore['pathtracing_slab_intersect'] = `
...
Effect.ShadersStore['pathtracing_sphere_intersect'] = `
...
Effect.ShadersStore['pathtracing_ellipsoid_param_intersect'] = `
...
Effect.ShadersStore['pathtracing_cylinder_param_intersect'] = `
...
Effect.ShadersStore['pathtracing_cone_param_intersect'] = `
...
Effect.ShadersStore['pathtracing_paraboloid_param_intersect'] = `
...
Effect.ShadersStore['pathtracing_hyperboloid_param_intersect'] = `
...
Effect.ShadersStore['pathtracing_hyperbolic_paraboloid_param_intersect'] = `
...
Effect.ShadersStore['pathtracing_ellipsoid_intersect'] = `
...
Effect.ShadersStore['pathtracing_opencylinder_intersect'] = `
...
Effect.ShadersStore['pathtracing_cappedcylinder_intersect'] = `
...
Effect.ShadersStore['pathtracing_cone_intersect'] = `
...
Effect.ShadersStore['pathtracing_capsule_intersect'] = `
...
Effect.ShadersStore['pathtracing_paraboloid_intersect'] = `
...
Effect.ShadersStore['pathtracing_torus_intersect'] = `
...
Effect.ShadersStore['pathtracing_quad_intersect'] = `
...
Effect.ShadersStore['pathtracing_box_intersect'] = `
...
Effect.ShadersStore['pathtracing_boundingbox_intersect'] = `
...
Effect.ShadersStore['pathtracing_bvhTriangle_intersect'] = `
...
Effect.ShadersStore['pathtracing_bvhDoubleSidedTriangle_intersect'] = `
...
Effect.ShadersStore['pathtracing_physical_sky_functions'] = `
...
Effect.ShadersStore['pathtracing_random_functions'] = `
...
Effect.ShadersStore['pathtracing_sample_sphere_light'] = `
...
Effect.ShadersStore['pathtracing_sample_quad_light'] = `
...
Effect.ShadersStore['pathtracing_calc_fresnel_reflectance'] = `
...
Effect.ShadersStore['pathtracing_main'] = `
